...
// schema auth - session - account - verification
...
export const doctorsTable = pgTable("doctors", {
  ...
  availableFromWeekDay: integer("avalaible_from_week_day").notNull(),
  availableToWeekDay: integer("avalaible_to_week_day").notNull(),
