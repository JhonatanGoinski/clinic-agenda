export enum MedicalSpecialty {
  ...
  ANÁLISES_CLÍNICAS = "Análises Clínicas",
  BANHO_DE_LUZ = "Banho de Luz (LED/laserterapia)",
  BIOESTÉTICA = "Bioestética",
  CITOPATOLOGIA = "Citopatologia",
  ESTÉTICA_AVANCADA = "Estética Avançada",
  HARMONIZAÇÃO_OROFACIAL = "Harmonização Orofacial",
  IMUNOLOGIA = "Imunologia",
  IMAGINOLOGIA = "Imagenologia (ou Diagnóstico por Imagem)",
  MICROBIOLOGIA = "Microbiologia",
  PARASITOLOGIA = "Parasitologia",
  PERÍCIA_CRIMINAL = "Perícia Criminal",
  TOXICOLOGIA = "Toxicologia",
  TRICHOLOGIA = "Tricologia (cuidados capilares)",
  GENÉTICA = "Genética",
  FISIOLOGIA_DO_ESFORÇO = "Fisiologia do Esforço",
  BIOMEDICINA_ESTÉTICA = "Biomedicina Estética",
  TERAPIAS_HORMONAIS = "Terapias Hormonais Integrativas",
